...
if ($searchQuery) {
    $stmt = $conn->prepare("SELECT * FROM recipes WHERE r_name LIKE ?");
...
<head>
 ...
 <link   href="https://cdn.jsdelivr.net/npm/remixicon@4.3.0/fonts/remixicon.css"
    rel="stylesheet"
/> 
    <link rel="stylesheet" href="assets/css/allrecipes.css">
</head>
...
<nav class="navbar navbar-expand-lg py-2 sticky-top">
    ...
    <div class="container py-4">
        <h1 class="text-center mb-4">Find Your Next Favorite Dish!</h1>
        
        <form method="GET" action="" class="mb-4">
    <div class="row justify-content-center py-3 mb-4">
        <div class="col-lg-8">
            <div class="input-group">
                <input type="text" name="search" class="form-control" placeholder="Search recipes..." aria-label="Search recipes..." aria-describedby="button-addon2" value="<?php echo htmlspecialchars($searchQuery); ?>">
                <button class="btn btn-brand" type="submit" id="button-addon2">Search</button>
            </div>
        </div>
    </div>
</form>
        ...
        <?php while ($row = $result->fetch_assoc()): ?>
            <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                <div class="card recipe-card position-relative overflow-hidden">
                    ...
                    <h3 class="recipe-title  text-center py-2"><?php echo $row['r_name']; ?></h3>
                    ...
                    <div class="image-wrapper position-relative">
                        ...
                        <!-- View Button (Over Image) -->
                        <a href="view-recipe.php?id=<?php echo $row['id']; ?>" class="btn btn-brand btn-sm view-button">View</a>
                    </div>
                </div>
            </div>
        <?php endwhile; ?>

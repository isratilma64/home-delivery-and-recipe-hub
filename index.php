...
/> 
 ...
 <style>
  ...
  height: 100%; /* Let flex control the height */
  background-color: #fff; /* Ensure consistency in card background */
}

.card-boxs .card img {
  max-height: 200px; /* Set consistent image height */
  object-fit: cover; /* Prevent image distortion */
}

.card-boxs .card .card-img-overlay {
  padding: 10px;
  flex-grow: 1; /* Allow content to fill space equally */
  display: flex;
  flex-direction: column;
  justify-content: flex-end; /* Align text and button to the bottom */
}

.card-boxs .card button {
...
.transparent-card {
    background-color: transparent !important; /* Make the entire card transparent */
  /* Add a border with var(--font-clr) */
    box-shadow: none; /* Remove card shadow */
    padding: 15px; /* Optional: add padding for some spacing */
}

/* Ensure card body is also transparent */
.card-body {
    background-color: transparent !important;
}

/* Text styles */
.card-title, .card-subtitle, p, small {
    color: var(--font-clr); /* Set text color to var(--font-clr) */
}

/* Optional: change the paragraph font size */
.card-body p {
    font-size: 1rem;
}
...
// Fetch reviews with related order details
$query = "
    ...
    <div class="container">
        <div class="row justify-content-center text-center">
            <div class="col-lg-10"   data-aos="fade-up" >
                <h1 class="display-4"  >-Homemade Harmony-<br> Recipes & Food Delivery Hub</h1>
                <p class="lead py-3">"Homemade Harmony is your go-to platform for sharing culinary creativity and enjoying authentic homemade meals delivered right to your doorstep. From recipe sharing to food delivery, it’s all about celebrating the art of home cooking."
                </p>
      ...
      <div class="row">
        <div class="col-12">
          <div class="section-tittle">
            <h2 class="text-center mt-2 mb-4 display-6 fw-bold"  >What would you like to cook today?</h2>
         ...
         <!--<div class="row justify-content-center mb-4">
            <div class="col-lg-8">
              <div class="input-group">
                ...
                <button class="btn btn-brand-2" type="button" id="button-addon2">Search</button>
              </div>
            </div>
          </div>
    ...
    <div class="slider mt-2">
      ...
      <div class="list " >
          ...
          <div class="item">
              ...
              <div class="content">
                <div class="title " style=" color: var(--color-bg-1)" >Fuel Your Day with Tasty,<br> Balanced Bites.</div>
                </div>
          ...
          <div class="item">
              ...
              <div class="content">
                  <div class="title" style=" color: var(--font-clr)">Eat Clean, Live Vibrantly: <br>Delicious & Nutritious<br> Recipes.</div>
          ...
          <div class="item">
              ...
              <div class="content">
                  <div class="title" style=" color: var(--pink)">Flavor-Packed Recipes for <br> Mindful Eating.</div>
              </div>
          </div>
...
<section id="popular-recipes">
  <div class="container my-2">
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-4 card-boxs">
      ...
      <div class="col" data-aos="fade-up" data-aos-delay="800">
        <div class="card" data-name="p-2">
          <img src="./assets/images/vegetable momos gran.jpg" class="card-img" alt="">
          <div class="card-img-overlay">
      ...
      <div class="col" data-aos="fade-up">
        <div class="card" data-name="p-3">
          <img src="./assets/images/Chicken-Dum-Biryani.jpg" class="card-img" alt="">
          <div class="card-img-overlay">
      ...
      <div class="col" data-aos="fade-up" data-aos-delay="1200">
        <div class="card" data-name="p-4">
          ...
          <div class="card-img-overlay">
            <h3 class="display-6  m-1 text-white">Chicken chashew nut salad</h3>
...
<div class="container mt-5"> 
  ...
  <h1 class="mb-4 mt-4">User Reviews</h1>
        ...
        <?php while ($row = $result->fetch_assoc()): ?>
            <div class="col-md-4 mb-3">
                <div class="card transparent-card">
                    <div class="card-body">
                        <h5 class="card-title" style="color:var(--font-clr)">
                            <?php echo htmlspecialchars($row['food_name']); ?>
                        </h5>
                        <h6 class="card-subtitle" style="color:var(--font-clr)">
                            Reviewed by <?php echo htmlspecialchars($row['username']); ?>
                        </h6>
                        <p class="mt-2" style="color:var(--font-clr)">
                        ...
                        <small style="color:var(--font-clr)">
...
<script>
    ...
    // Handle the "Share Recipe" link click
    document.getElementById('shareRecipeLink').addEventListener('click', function (event) {
        if (!isLoggedIn) {
            // Prevent the default action
            event.preventDefault();

            // Show an alert message
            alert("You need to log in first to share a recipe!");
